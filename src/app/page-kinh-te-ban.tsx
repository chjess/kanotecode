...
import {
  ...
  Terminal, Shield, Sparkles, ChevronLeft, ChevronRight,
  Smartphone, Zap, Cpu
} from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            <div className="relative">
              <img src="assets/logo.png" alt="KanoteCode" className="w-64 h-64 rounded-3xl border border-[#162B55] shadow-2xl shadow-violet-500/20" />
  ...
  return (
    <section id="workflow" className="py-20 md:py-28" ref={ref}>
      <div className="container mx-auto px-6">
        ...
        >
          <p className="text-sm font-bold tracking-widest uppercase text-violet-300 mb-3">Quy trình</p>
...
function Story() {
  ...
  const pages = [
    {
      content: (
        <div className="max-w-2xl">
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-4 leading-relaxed">Có những ý tưởng xuất hiện vào lúc nửa đêm.</p>
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-6 leading-relaxed">Khi trước mặt chỉ còn một chiếc điện thoại, một ý tưởng chưa thành hình, và một câu hỏi rất đơn giản:</p>
          ...
          <p className="text-lg text-[#A8B0C2] mb-3">Không máy tính.</p>
          <p className="text-lg text-[#A8B0C2] mb-3">Không VPS.</p>
          <p className="text-lg text-[#A8B0C2] mb-3">Không một môi trường phát triển quen thuộc.</p>
          <p className="text-lg text-[#A8B0C2] mb-6">Chỉ có chiếc điện thoại đang nằm trong tay.</p>
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-6">Vậy liệu có thể mang một coding agent vào đó không?</p>
    ...
    },
    {
      content: (
        <div className="max-w-2xl">
          ...
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-4 leading-relaxed">KanoteCode không được tạo ra với mục tiêu trở thành một ứng dụng hoàn hảo ngay từ phiên bản đầu tiên.</p>
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-6 leading-relaxed">Nó bắt đầu khá vụng về.</p>
          <div className="space-y-3 mb-6">
            <p className="text-lg text-[#A8B0C2] flex items-start gap-3"><span className="text-violet-400">▸</span> Có những thứ hoạt động chưa thật mượt.</p>
            <p className="text-lg text-[#A8B0C2] flex items-start gap-3"><span className="text-violet-400">▸</span> Có những tính năng còn đang thử nghiệm.</p>
            <p className="text-lg text-[#A8B0C2] flex items-start gap-3"><span className="text-violet-400">▸</span> Có những giới hạn mà chúng tôi vẫn đang tìm cách vượt qua.</p>
          </div>
    ...
    },
    {
      content: (
        <div className="max-w-2xl">
          ...
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-6 leading-relaxed">Ban đầu chỉ là một câu hỏi. Sau đó là một project.</p>
          <div className="space-y-3 mb-6">
            {[
              "Rồi một editor",
              "Một file explorer",
              ...
              <motion.p
                ...
                className="text-lg text-[#A8B0C2] flex items-start gap-3"
              >
                <span className="text-violet-400 font-bold">0{i + 1}</span> {item}
              </motion.p>
            ))}
          </div>
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-4">Từng thứ một được ghép lại.</p>
    ...
    },
    {
      content: (
        <div className="max-w-2xl">
          ...
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-4 leading-relaxed">Và có lẽ điều đó cũng không sao.</p>
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-6 leading-relaxed">Một ứng dụng dành cho việc biến ý tưởng thành code thì bản thân nó cũng nên được xây dựng theo cách đó:</p>
          <p className="text-xl md:text-2xl text-white font-semibold mb-3 italic">từng dòng một, từng phiên bản một.</p>
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-3">Hôm nay nó có thể làm được một việc.</p>
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-3">Ngày mai có thể thêm một tool.</p>
          <p className="text-lg md:text-xl text-[#A8B0C2] leading-relaxed">Và biết đâu, một trong những tính năng tiếp theo lại bắt đầu từ chính một góp ý của bạn.</p>
        </div>
      ),
    },
    {
      content: (
        <div className="max-w-2xl">
          ...
          <div className="space-y-4 mb-6">
            <p className="text-lg md:text-xl text-[#A8B0C2]"><span className="text-violet-400 font-bold">→</span> Có thể bạn là developer.</p>
            <p className="text-lg md:text-xl text-[#A8B0C2]"><span className="text-violet-400 font-bold">→</span> Có thể bạn chỉ đang học code.</p>
            <p className="text-lg md:text-xl text-[#A8B0C2]"><span className="text-violet-400 font-bold">→</span> Hoặc đơn giản là bạn có một ý tưởng và muốn thử.</p>
          </div>
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-4 leading-relaxed">KanoteCode không hứa rằng mọi thứ sẽ dễ dàng.</p>
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-4 leading-relaxed">Nó chỉ muốn giúp bạn bắt đầu nhanh hơn.</p>
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-6 leading-relaxed">Mở điện thoại. Mở project. Nói với agent điều bạn muốn làm. Xem nó thay đổi code. Duyệt những gì mình thích. Sửa những gì chưa đúng. Rồi tiếp tục.</p>
    ...
    },
    {
      content: (
        <div className="max-w-2xl text-center">
          ...
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-4">Nó vẫn còn đang hoàn thiện.</p>
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-4">Nhưng có lẽ, đó mới là phần thú vị nhất.</p>
          <p className="text-lg md:text-xl text-[#A8B0C2] mb-6 leading-relaxed">Nếu bạn thấy nó còn thiếu điều gì, hãy nói với chúng tôi.</p>
  ...
  return (
    <section id="story" className="relative overflow-hidden" ref={useRef(null)}>
      <div className="container mx-auto px-6">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
        ...
        >
          ...
          <p className="text-[#A8B0C2]">7 trang ngắn — bấm nút hoặc vuốt để lật.</p>
        </motion.div>
    ...
    <section id="features" className="py-20 md:py-28" ref={ref}>
      <div className="container mx-auto px-6">
        <motion.div
          ...
          transition={{ duration: 0.7 }}
        >
          <p className="text-sm font-bold tracking-widest uppercase text-violet-300 mb-3">Tính năng</p>
    ...
    <section id="roadmap" className="py-20 md:py-28" ref={ref}>
      <div className="container mx-auto px-6">
        <motion.div
          ...
          transition={{ duration: 0.7 }}
        >
          <p className="text-sm font-bold tracking-widest uppercase text-violet-300 mb-3">Sắp tới</p>
    ...
    <section id="download" className="py-20 md:py-28" ref={ref}>
      <div className="container mx-auto px-6">
        <motion.div
          ...
          transition={{ duration: 0.7 }}
        >
          <p className="text-sm font-bold tracking-widest uppercase text-violet-300 mb-3">Tải về</p>
          ...
          >
            ...
            <Button size="lg" className="px-8 py-4 text-lg whitespace-nowrap">⬇ Tải APK (76MB)</Button>
          </motion.div>
        </motion.div>
      </div>
    </section>
